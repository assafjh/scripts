...
BYPASS_CA_CERTIFICATE_FILE_PATH="$SCRIPT_DIR/certs/rootCA.pem" BYPASS_CA_KEY_FILE_PATH="$SCRIPT_DIR/certs/rootCA.key" BYPASS_SERVER_CERTIFICATE_FILE_PATH="$SCRIPT_DIR/certs/registry/server.pem" "$GENERATE_CERTIFICATES_SCRIPTS_DIR"/04-sign-csr.sh
